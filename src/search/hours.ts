 ...
 *
 * The opening_hours grammar is enormous. This covers the shapes that are
 * useful for curated campus data — "24/7", "Mo-Fr 09:00-20:00",
 * "Mo-Sa 08:30-19:30; Su off", multiple ranges — and returns `null` for
 * anything it does not understand rather than guessing. A wrong "open now"
 * is worse than none.
 */
